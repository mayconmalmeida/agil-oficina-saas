...
-- Allow authenticated users to modify plan configurations (for admin panel)
-- This is more permissive but necessary for the admin functionality to work
CREATE POLICY "Allow authenticated users to modify plan configurations"
ON plan_configurations FOR ALL
