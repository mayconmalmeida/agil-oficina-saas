...
export const premiumRoutes = [
  ...
  // Gestão de Orçamentos - ESSENCIAL
  ...
  // Configurações da Empresa - ESSENCIAL
  ...
  // RECURSOS PREMIUM (só acessíveis durante trial ou plano premium)
  
  // Agendamento de Serviços - PREMIUM
