...
// Base de dados simulada de veículos (incluindo novos formatos)
const vehicleDatabase: Record<string, VehicleData> = {
  ...
  // Novos formatos de placa (padrão Mercosul)
  'ABC1D23': { marca: 'Toyota', modelo: 'Corolla Cross', ano: '2023' },
  'DEF2E45': { marca: 'Honda', modelo: 'HR-V', ano: '2023' },
  'GHI3F67': { marca: 'Ford', modelo: 'Territory', ano: '2024' },
  'JKL4G89': { marca: 'Chevrolet', modelo: 'Tracker', ano: '2023' },
  'MNO5H01': { marca: 'Volkswagen', modelo: 'T-Cross', ano: '2024' },
  'PQR6I23': { marca: 'Fiat', modelo: 'Pulse', ano: '2023' },
  'STU7J45': { marca: 'Nissan', modelo: 'Kicks', ano: '2024' },
  'VWX8K67': { marca: 'Hyundai', modelo: 'Creta', ano: '2023' },
  'YZA9L89': { marca: 'Renault', modelo: 'Captur', ano: '2024' }
};
...
export const searchVehicleByPlate = async (plate: string): Promise<VehicleData | null> => {
  ...
  // Remove formatação da placa para busca (hífens, espaços)
  ...
  console.log('Dados gerados aleatoriamente:', randomData);
  return randomData;
};
